...
COMMENT ON COLUMN P_GAME_TAG.TAGID IS '태그아이디';
...
COMMENT ON COLUMN P_NEWS.RNO IS '뉴스 번호';
...
COMMENT ON COLUMN P_NIJI_TAG.TAGID IS '태그 아이디';
...
COMMENT ON TABLE P_TAG IS '태그';
COMMENT ON COLUMN P_TAG.TAGID IS '태그 아이디';
COMMENT ON COLUMN P_TAG.TAGNAME IS '태그명';
