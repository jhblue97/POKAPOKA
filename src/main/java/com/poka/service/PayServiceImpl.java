...
import com.poka.domain.EmailDTO;
...
public class PayServiceImpl implements PayService {
	...
	public void add(PayVO payvo) {
		...
		if(payvo.getPay_status()==2) {
			System.out.println("ggggg"+payvo.getBuyer_email());
			EmailDTO email = new EmailDTO();
			email.setMessage("イメージ　----> "+payvo.getImg());
			email.setReceiveMail(payvo.getBuyer_email());
			email.setSenderMail("jhblue05@gmail.com");
			email.setSubject("購買イメージ");
			email.setSenderName("POKAPOKA");
			sendMail(email);
		}
